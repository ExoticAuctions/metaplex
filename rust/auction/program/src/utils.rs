...
///TokenTransferParams
pub struct TokenTransferParamsWithKey<'a: 'b, 'b> {
    /// source
    pub source: AccountInfo<'a>,
    /// destination
...
#[inline(always)]
pub fn spl_token_transfer_with_key(params: TokenTransferParamsWithKey<'_, '_>) -> ProgramResult {
    let TokenTransferParamsWithKey {
        source,
        destination,
        authority,
        token_program,
