...
export class AuctionDataExtended {
  ...
  rewardSize : BN | null;
  prevBidderToken : StringPublicKey | null;
  ...
  constructor(args: {
    ...
    this.rewardSize = args.rewardSize;
    this.prevBidderToken = args.prevBidderToken;
  }
}
  ...
  [
    AuctionDataExtended,
    {
      ...
      fields: [
        ...
        ['tickSize', { kind: 'option', type: 'u64' }],
        ['gapTickSizePercentage', { kind: 'option', type: 'u8' }],
        ['rewardSize', { kind: 'option', type: 'u64' }],
        ['prevBidderToken', { kind: 'option', type: 'pubkeyAsString' }],
      ],
    },
  ],
  [
