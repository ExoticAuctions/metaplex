...
//const programId=new PublicKey('5kLHpCBo6qXTjxkVZ1BfAjm4A8rsRivHNdsXzbzUN4VR')
//const programId=new PublicKey('3Q3X596ymjmPtyuUWwQH58FXV7sVuDr8Bbtfe6rpygW1')
const programId=new PublicKey('9vjUcvaJGp5E85iZexCv9DsQLrGuNF3VPVXCHQWen7si')
//var messagePubkey = new PublicKey('FCQfwKGiXoxA2Tq1zdRWgi4kaXynK24bhNkxWrc4u1aS')
var messagePubkey = new PublicKey('3xrCgtY1FKPzMjVJHB8FUPisP5n9zUApsqfj61JDC6wp')
...
export class tokenEngine{
	...
	createToken = async () =>{
		...
		let mint = await splToken.Token.createMint(this.connection,fromWallet,fromWallet.publicKey,null,1,splToken.TOKEN_PROGRAM_ID)
